  ...
  <div class="name-input">
    <div class="columnsis-gapless">
      <div class="column is-full">
        ...
        <input
          class="no-new-line neme-form-input input"
          type="text"
          placeholder="お名前(8文字まで)"
          v-model="name"
        />
        <button
          class="no-new-line neme-form-button button  is-danger"
          @click="DeleteName"
        >
          削除
        </button>
...
export default {
  ...
  methods: {
    ...
    ValidateName: function() {
      ...
      console.log(
        `this.name.length=${
          this.$store.state.names[this.index].length
